...
CONVERSATION_OUTCOMES = Table(
    ...
    Column("reply_length", Integer),
    Column("semantic_substance", Float),
    Column("emotional_shift", Float),
    Column("disclosure_depth", Float),
    ...
    Column("correction_signal", Boolean, nullable=False, default=False),
    Column("boundary_signal", Boolean, nullable=False, default=False),
    Column("bot_suspicion", Boolean, nullable=False, default=False),
    Column("manual_creator_takeover", Boolean, nullable=False, default=False),
    Column("composite_quality", Float),
...
FAN_CONVERSATION_STATES = Table(
    ...
    Column("current_intent", String(96)),
    Column("underlying_need", String(120)),
    Column("openness_estimate", Float, nullable=False, default=0.0),
    Column("sexual_intensity", Float, nullable=False, default=0.0),
    Column("uncertainty_estimate", Float, nullable=False, default=0.0),
    Column("boundary_signal", String(128)),
    ...
    Column("familiarity_estimate", Float, nullable=False, default=0.0),
    Column("warmth_estimate", Float, nullable=False, default=0.5),
    Column("reciprocity_estimate", Float, nullable=False, default=0.0),
    Column("playfulness_estimate", Float, nullable=False, default=0.5),
    Column("emotional_depth", Float, nullable=False, default=0.0),
    Column("fantasy_openness", Float, nullable=False, default=0.0),
    ...
    Column("current_momentum", String(32), nullable=False, default="steady"),
    Column("intimacy_ceiling", String(32), nullable=False, default="neutral"),
    Column("direct_unanswered_question", Text),
    Column("unresolved_emotional_thread", Text),
    Column("creator_promise", Text),
    Column("fan_promise", Text),
    Column("future_callback", Text),
    Column("last_successful_act", String(64)),
    Column("recent_failed_acts", JSON, nullable=False, default=list),
    Column("recommended_next_act", String(64)),
    Column("last_source_message_id", String(128)),
    Column("last_source_timestamp", DateTime(timezone=True)),

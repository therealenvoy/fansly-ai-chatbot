...
REQUIRED_VARS = [
    ...
    "PLAYBOOK_ENGINE_MODE",
    "RELATIONSHIP_STATE_V2_MODE",
    "MEMORY_RETRIEVAL_V3_MODE",
    "STRATEGY_PLANNER_V2_MODE",
    "GLOBAL_DIVERSITY_MODE",
    "OUTCOME_LEARNING_MODE",
    "MULTI_BUBBLE_MODE",
    "CONVERSATION_INTELLIGENCE_V3_ALLOW_SEND",
    "CONVERSATION_INTELLIGENCE_V3_SHADOW_PERCENT",
